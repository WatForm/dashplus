...
public final class AlloyDecl extends AlloyExpr {
  ...
  public AlloyDecl(
    ...
    if (!this.mul.isEmpty()
      ...
      throw AlloyCtorError.invalidAlloyQtEnum(
          pos,
          this.getClass().getSimpleName() + ".mul must be LONE, ONE, SOME, SET, SEQ, or EXACTLY. ");
    }
  }
  ...
  */
  ...
  public int hashCode() {
    return Objects.hash(
        this.isVar, this.isPrivate, this.isDisj1, this.qnames, this.isDisj2, this.mul, this.expr);
  }
