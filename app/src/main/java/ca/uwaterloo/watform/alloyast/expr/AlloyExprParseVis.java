...
public class AlloyExprParseVis extends DashBaseVisitor<AlloyExpr> {
  ...
  */
  ...
  @Override
  public AlloyQuantificationExpr visitQuantificationExpr(DashParser.QuantificationExprContext ctx) {
  ...
  public AlloyNumExpr visitNumber(DashParser.NumberContext ctx) {
    return new AlloyNumExpr(
        new Pos(ctx),
        null == ctx.MINUS() ? ctx.NUMBER().getText() : AlloyStrings.MINUS + ctx.NUMBER().getText());
  }
  ...
  public AlloyBracketExpr visitBracketExpr(DashParser.BracketExprContext ctx) {
    return new AlloyBracketExpr(
        new Pos(ctx), this.visit(ctx.expr2()), visitAll(ctx.expr1(), this, AlloyExpr.class));
  }

  @Override
  public AlloyBracketExpr visitBracketBuiltinExpr(DashParser.BracketBuiltinExprContext ctx) {
    return new AlloyBracketExpr(
        new Pos(ctx), this.visit(ctx.getChild(0)), visitAll(ctx.expr1(), this, AlloyExpr.class));
  }
