    ...
    */
    ...
    public CommandDecl(
      ...
      if (!this.invoQname.isEmpty() && !this.constrBlock.isEmpty()) {
        throw AlloyCtorError.xorFields(pos, "invoQname", "constrBlock", "AlloyCmdPara.CommandDecl");
      }
      if (this.invoQname.isEmpty() && this.constrBlock.isEmpty()) {
        throw AlloyCtorError.xorFields(pos, "invoQname", "constrBlock", "AlloyCmdPara.CommandDecl");
      }
    ...
    public int hashCode() {
      return Objects.hash(
          this.cmdType, this.declQname, this.invoQname, this.constrBlock, this.scope, this.expect);
    }
      ...
      public void toString(StringBuilder sb, int indent) {
        ...
        if (!this.num.isEmpty()) {
          ...
          if (!this.typescopes.isEmpty()) {
            ...
            ASTNode.join(sb, indent, this.typescopes, AlloyStrings.COMMA + AlloyStrings.SPACE);
          }
      ...
      */
      ...
      public static final class Typescope extends ASTNode {
        ...
        public Typescope(
          ...
          if (this.start.value < 0 || (this.end.isPresent() && this.end.get().value < 0)) {
            throw AlloyCtorError.cmdNegScop(pos);
          }

          if (this.end.isPresent()) throw AssumptionError.cantHaveScopeRange(pos, this.toString());
          ...
          reqNonNull(nullField(pos, this), this.start, this.end, this.increment, this.scopableExpr);
        }
        ...
        public Typescope(boolean isExactly, int start, int end, int increment, String name) {
          this(
              Pos.UNKNOWN,
              isExactly,
              new AlloyNumExpr(start),
