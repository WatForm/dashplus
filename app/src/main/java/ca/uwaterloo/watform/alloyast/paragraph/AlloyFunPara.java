...
public final class AlloyFunPara extends AlloyPara {
  ...
  public AlloyFunPara(boolean isPrivate, AlloyQnameExpr qname, AlloyExpr sub, AlloyBlock block) {
    this(Pos.UNKNOWN, isPrivate, null, qname, Collections.emptyList(), Mul.DEFAULTSET, sub, block);
  }
  ...
  public int hashCode() {
    return Objects.hash(
        this.isPrivate, this.sigRef, this.qname, this.arguments, this.mul, this.sub, this.block);
  }
