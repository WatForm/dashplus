...
public final class AlloySigPara extends AlloyPara {
  ...
  public AlloySigPara(
    ...
    reqNonNull(nullField(pos, this), this.quals, this.qnames, this.rel, this.fields, this.block);
  }
  ...
  public AlloySigPara(AlloyQnameExpr qname, List<AlloyDecl> fields) {
    this(
        Pos.UNKNOWN, Collections.emptyList(), Collections.singletonList(qname), null, fields, null);
  }
  ...
  */
  ...
  public boolean isSubset() {
    return this.rel.isPresent()
        && (this.rel.get().getClass() == In.class || this.rel.get().getClass() == Equal.class);
  }
