...
public class AlloyCtorError extends UserOrImplError {
  ...
  public static AlloyCtorError growingScope(Pos pos, AlloyScopableExpr scopableExpr) {
    return new AlloyCtorError(pos, "Cannot specify a growing scope for " + scopableExpr.toString());
  }
  ...
  public static AlloyCtorError declExactlyCannotHaveDisj(Pos pos) {
    throw new AlloyCtorError(
        pos, "Decl with quant EXACTLY cannot be disjoint on either " + "side and cannot be var. ");
  }
  ...
  */
   ...
   */
  public static AlloyCtorError xorFields(Pos pos, String field1, String field2, String className) {
    return new AlloyCtorError(
        pos,
        field1
            + " and "
