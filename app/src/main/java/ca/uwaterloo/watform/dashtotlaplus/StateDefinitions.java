...
public class StateDefinitions {
    ...
    public static void stateFormulae(DashModel dashModel, TlaModel tlaPlusModel) {
        ...
        names.reversed()
                .forEach(
                        x -> {
                            if (dashModel.st.isLeaf(x)) LeafStateDefinition(x, tlaPlusModel);
                            else nonLeafStateDefinition(x, dashModel, tlaPlusModel);
                        });
    }
    ...
    public static void LeafStateDefinition(String s, TlaModel tlaPlusModel) {
