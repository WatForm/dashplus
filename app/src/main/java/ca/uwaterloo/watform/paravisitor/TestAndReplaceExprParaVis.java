...
public class TestAndReplaceExprParaVis implements AlloyParaVis<AlloyPara> {
  ...
  public AlloyPara visit(AlloyMacroPara macroPara) {
    return macroPara.rebuild(
        ((AlloyBlock) (macroPara.block.map(b -> testAndReplaceExprVis.visit(b)).orElse(null))),
  ...
  public AlloyPara visit(AlloyPredPara predPara) {
    ...
    AlloyPredPara newPredPara =
        predPara.rebuild(
            mapBy(predPara.arguments, a -> ((AlloyDecl) testAndReplaceExprVis.visit(a))),
    ...
    return new AlloyCmdPara(
        ...
        mapBy(
            ...
            d ->
                (d.rebuild(
                    ((AlloyBlock)
                        d.constrBlock.map(x -> testAndReplaceExprVis.visit(x)).orElse(null))))));
  }
