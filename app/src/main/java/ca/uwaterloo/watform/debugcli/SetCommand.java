...
public class SetCommand extends DebugCommand {
    ...
    private void setConf(String[] input, DebugSimulationManager simulationManager) {
        if (input.length < 3) {
    ...
    private void setDiffMode(String[] input, DebugSimulationManager simulationManager) {
        if (input.length < 3) {
            System.out.println(getHelp());
            return;
        }
