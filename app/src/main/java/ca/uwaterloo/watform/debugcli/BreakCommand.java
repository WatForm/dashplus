...
public class BreakCommand extends DebugCommand {
    ...
    public void execute(String[] input, DebugSimulationManager simulationManager) {
        ...
        if (arg.equals(RM_FLAG)) {
            ...
            if (!cm.removeConstraint(constraintID)) {
                System.out.println(
                        String.format(CommandConstants.INVALID_CONSTRAINT_ID, constraintID));
            }
            ...
            while (m.find()) {
                ...
                if (simulationManager.validateConstraint(constraint)) {
                    ...
                    System.out.println(
                            String.format(CommandConstants.INVALID_CONSTRAINT, constraint));
                }
            }
        }
    }
