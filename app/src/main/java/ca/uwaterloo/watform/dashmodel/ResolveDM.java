...
public class ResolveDM extends ResolverVisDM {
  ...
  private void extraChecks() {
    ...
    List<String> statesNotEntered =
        filterBy(
            allStateNames(),
            i -> !(isDefault(i) || isAnd(i) || isRoot(i) || transDestNames().contains(i)));
  ...
  private class Error {
    ...
    public static void envEventsNotUsed(List<String> envEventsNotUsed) throws Reporter.ErrorUser {
      throw new Reporter.ErrorUser(
          "The following environmental events are never used: " + strCommaList(envEventsNotUsed));
    }
