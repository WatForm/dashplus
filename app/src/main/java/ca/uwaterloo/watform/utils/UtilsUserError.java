...
public class UtilsUserError extends UserOrImplError {
  ...
  public static UtilsUserError outputDirectory(String directory, String causeMsg) {
    return new UtilsUserError("Could not create output directory " + directory + ": " + causeMsg);
  }
}
