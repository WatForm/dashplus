...
public final class PPrinter {
    ...
    public static final int largeSize = PPrinter.lineWidth * 2;
    public static final int indentSize = 4;

    public PPrinter(Writer w, int lineWidth, int indentSize) {
        this.layouter = new Layouter<>(new WriterBackend(w, lineWidth), indentSize);
    }

    public PPrinter(Writer w) {
        this(w, PPrinter.lineWidth, PPrinter.indentSize);
    }
    ...
    public void brkNoIndent() {
        this.brk(1, -PPrinter.indentSize);
    }
    ...
    public void nlNoIndent() {
        this.brk(PPrinter.largeSize, -PPrinter.indentSize);
    }
