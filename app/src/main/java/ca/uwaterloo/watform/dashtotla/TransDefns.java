...
public class TransDefns {
  ...
  public static void NextIsStableDefn(DashModel dashModel, TlaModel tlaModel) {
    ...
    List<TlaExp> notEnabledTrans =
        mapBy(
            ...
            tFQN -> TlaNot(TlaAppl(enabledTransTlaFQN(tFQN), enabledParams(dashModel))));

    tlaModel.addDefn(
        // _next_is_stable(args) = /\ (~ enabled_after_step_ti(args) ...)
        TlaDefn(TlaDecl(NEXT_IS_STABLE, enabledParams(dashModel)), repeatedAnd(notEnabledTrans)));
  }
  ...
  public static void TransEnabledDefn(String transFQN, DashModel dashModel, TlaModel tlaModel) {
    ...
    tlaModel.addDefn(
        TlaDefn(
            TlaDecl(enabledTransTlaFQN(transFQN), enabledParams(dashModel)), repeatedAnd(exps)));
  }
