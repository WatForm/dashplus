...
class DashToTlaStrings {
  ...
  public static final String SOME_PRE_TRANSITION = SPECIAL + "some" + PRE + SPECIAL + "transition";
  ...
  public static final String ENVIRONMENTAL_EVENTS = SPECIAL + "environmental" + SPECIAL + "events";
