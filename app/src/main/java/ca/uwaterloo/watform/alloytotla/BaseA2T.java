...
public class BaseA2T {
	...
	public BaseA2T(AlloyModel alloyModel, String moduleName, boolean verbose, boolean debug)
	{
		this.alloyModel = alloyModel;
		this.tlaModel = new TlaModel(moduleName, new TlaAppl(INIT), new TlaAppl(NEXT));
