...
public class InitDefnA2T extends FieldsA2T {
    ...
    public InitDefnA2T(AlloyModel alloyModel, boolean verbose, boolean debug, Optimization optimization) {
    ...
    //             scopeConstraints.add(repeatedOr(mapBy(possibleSets, set ->
    // TlaVar(s).EQUALS(set))));
    //         }
    //     }
