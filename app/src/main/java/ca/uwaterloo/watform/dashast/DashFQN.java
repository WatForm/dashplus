/*
    This package is used very little in the dash ast elements, but
    it is needed for when a DashParam is treated as an AlloyVar in the
    paramValues of a DashRef
*/
