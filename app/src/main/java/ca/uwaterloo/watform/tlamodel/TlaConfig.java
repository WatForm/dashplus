...
public class TlaConfig {
  ...
  private String constantsString() {
    ...
    for (TlaExp e : this.constants) answer.append(e.toTLAPlusSnippetCore() + TlaStrings.NEWLINE);
  ...
  private String invariantsString() {
    ...
    answer.append(TlaStrings.NEWLINE);
    for (TlaExp e : this.invariants) answer.append(e.toTLAPlusSnippetCore() + TlaStrings.NEWLINE);
    return answer.toString();
  }
